...
include "conn.php";
include "conn.php";
$strSQL = "SELECT * FROM resume, data_pribadi";
    ...
    <div class="container">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="resume.php#resume">Resume</a></li>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4><?= $dataSQL["name"] ?></h4>
            <!-- <p><em>Aspiring full-stack web developer with experience designing and developing website from initial concept to final, polished deployable website.</em></p> -->
            <p><em><?= $dataSQL["summary_desc"] ?></em></p>
            <p>
            <ul>
              <li><?= $dataSQL["address"] ?></li>
              <li><?= $dataSQL["phone"] ?></li>
              <li><?= $dataSQL["email"] ?></li>
            </ul>
            </p>
          ...
          <div class="resume-item">
            <h4><?= $dataSQL["edu_1"] ?></h4>
            <h5><?= $dataSQL["edu_1_dur"] ?></h5>
            <p><em><?= $dataSQL["edu_1_inst"] ?></em></p>
          </div>
        </div>
      </div>
